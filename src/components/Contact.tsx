...
Message: ${formData.get('message')}
    ...
    window.location.href = `mailto:contact@jaipurescorts.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    ...
                    <div className="flex flex-col items-center text-center space-y-2">
                      ...
                      <div>
                        ...
                        <a href="mailto:contact@jaipurescorts.com" className="text-gray-600 dark:text-gray-300 hover:text-rose-500">
                          contact@jaipurescorts.com
                        </a>
                      </div>
                    </div>
