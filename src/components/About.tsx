            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center">
                  100% verified jaipur calll-girl profiles with real photos and genuine services in Jaipur.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center">
                  Complete discretion and confidentiality for all our clients with our jaipur calll-girl.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 dark:text-gray-300 text-center">
                  Round-the-clock service with instant booking confirmation of our jaipur calll-girl.
                </p>
              </div>
            </div>
          </div>
