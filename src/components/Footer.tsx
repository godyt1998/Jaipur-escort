        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-0">
          ...
          <div className="flex flex-col items-center md:items-start md:ml-8">
            ...
            <p className="text-gray-400 text-center md:text-left max-w-xs">
              Your trusted companion for premium experiences in Jaipur. Jaipur Escorts ensures discretion and quality service. Independent Escort Service.
            </p>
          </div>
          {/* Quick Links */}
          ...
          <div className="text-center md:text-left md:pl-16">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="mailto:contact@jaipurescorts.com" className="text-gray-400 hover:text-rose-500 transition-colors inline-flex items-center justify-center md:justify-start">
