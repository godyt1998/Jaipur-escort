...
const FAQ = () => {
  const faqs: FAQItem[] = [
    {
      question: 'What services does Jaipur Escorts offer?',
      answer: 'Jaipur Escorts offers premium companion services in Jaipur, ensuring discretion and professionalism in all our interactions.'
    },
    {
      ...
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-gray-900 dark:text-white text-center mb-12">
            Frequently Asked Questions about Jaipur Escorts
          </h2>
